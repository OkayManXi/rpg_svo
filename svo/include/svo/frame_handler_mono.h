...
class FrameHandlerMono : public FrameHandlerBase
{
  ...
  protected:
    ...
    vector<pair<FramePtr, size_t>> overlap_kfs_;  //!< All keyframes with overlapping field of view. the paired number specifies how many common
                                                  //!mappoints are observed TODO: why vector!?
