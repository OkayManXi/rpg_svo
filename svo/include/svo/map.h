...
class Map : boost::noncopyable
{
  public:
    ...
    list<Point *> trash_points_;  //!< A deleted point is moved to the trash bin. Now and then this is cleaned. One reason is that the visualizer must
                                  //!remove the points also.
